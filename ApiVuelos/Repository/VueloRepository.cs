...
{
    public class VueloRepository : IRepository<Vuelo>, IVueloRepository<Vuelo>
    {
        ...
        public async Task<IEnumerable<Vuelo>> GetByPriceAsc() =>
            await _context.Vuelos.OrderBy(v => v.Precio).ToListAsync();

        public async Task<IEnumerable<Vuelo>> GetByPriceDesc() =>
            await _context.Vuelos.OrderByDescending(v => v.Precio).ToListAsync();
