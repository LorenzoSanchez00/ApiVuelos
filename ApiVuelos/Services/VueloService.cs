...
{
    public class VueloService : ICommonService<VueloDto, CrearVueloDto, ModificarVueloDto>, IVueloService<VueloDto>
    {
        private readonly IRepository<Vuelo> _repository;
        private readonly IVueloRepository<Vuelo> _vueloRepository;
        private readonly IMapper _mapper;

        public VueloService(IRepository<Vuelo> repository, IMapper mapper, IVueloRepository<Vuelo> vueloRepository)
        {
        ...
        {
            var vuelos = await _vueloRepository.GetByPriceAsc();
        ...
        {
            var vuelos = await _vueloRepository.GetByPriceDesc();
